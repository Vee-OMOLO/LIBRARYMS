...
Public Class Form1
    ...
    Dim Server As String = "DESKTOP-G9094QM"
    Dim Database As String = "LibrarydDB"

    Private bitmap As Bitmap
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'LibrarydDBDataSet.Books' table. You can move, or remove it, as needed.
        Me.BooksTableAdapter.Fill(Me.LibrarydDBDataSet.Books)
        updatetable()
    End Sub
